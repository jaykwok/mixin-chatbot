...
test.each(["runtime", "legacy-schema"])("audit counterexamples and startup schema guard: %s", async mode => {
  ...
  const child = Bun.spawn([process.execPath, fileURLToPath(new URL("../helpers/audit-runtime-harness.ts", import.meta.url)), mode], {
    cwd: fixture.root, env: { ...process.env, GROUP_DATA_ROOT: "data/groups", BOT_MAX_ACTIVE_REQUESTS: "32", BOT_MODEL_CACHE_RETENTION: "auto" },
...
test.each([["astra", "auto"], ["zai", "auto"], ["astra", "long"], ["legacy", "long"], ["sdk-env", "auto"], ["document-work-disabled", "auto"], ["group-env", "auto"], ["shared-env", "auto"]])(

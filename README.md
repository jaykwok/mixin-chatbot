...
默认提供产品资料助手提示词和文档加工 skill，支持查询产品、发送原件、修改 Word、选编 PPT、整理方案和制作对比表，适用于售前、交付及售后文档工作。修改 [prompt.ts](src/agent/prompt.ts) 可调整用途，文档能力见[设计说明](docs/document-tools.md)。

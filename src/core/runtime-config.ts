...
export const RUNTIME_KEYS = [
  ...
  "BOT_RUN_TIMEOUT_SECONDS", "BOT_MODEL_IDLE_TIMEOUT_SECONDS", "BOT_SHUTDOWN_TIMEOUT_SECONDS", "BOT_DELIVERY_TIMEOUT_SECONDS",
  "BOT_DOCUMENT_ENV",
] as const;
...
const ranges: Partial<Record<RuntimeKey, [number, number]>> = {
  ...
  BOT_MODEL_IDLE_TIMEOUT_SECONDS: [10, 7200],
};
